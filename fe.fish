...
echo (set_color FEDB39)"***"
echo (set_color FEDB39)"https://github.com/liqowomo/lq-rosto-tut-1/-/tree/lq/a"
echo (set_color FEDB39)"***"
...
echo (set_color blue ) "    --repo="https://github.com/liqowomo/lq-rosto-tut-1 \\" "
echo (set_color blue ) "    --branch="lq" \\"
echo (set_color blue ) "    --source-path="b" \\"
echo (set_color blue ) "    --progress \\ "
echo (set_color blue ) "    $diro "
fetch \
    --repo="https://github.com/liqowomo/lq-rosto-tut-1" \
    --branch="lq" \
    --source-path="b" \
    --progress \
    $diro
